...
const AbsencePresentation: React.FC<AbsencePresentationProps> = ({
    ...
    const isDateDisabled = (date: dayjs.Dayjs) => {
        ...
        const allowedDays = selectedPerson.weekDays.map((day) => {
            ...
            if (dayName === null) {
                throw new Error(
                    `Unexpected null value for day with id ${day.id}`
                );
            }
            ...
            {selectedPerson && (
                ...
                >
                    <Typography variant="h6" gutterBottom>
                        ايام عمل{" "}
                        {personType === "doctor" ? "الدكتور" : "الموظف"}{" "}
                    ...
                    >
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <Select
                                                ...
                                                onChange={(
                                                    selectedOption: SingleValue<DayOption>
                                                ) => {
                                                    field.onChange(
                            ...
                            <DialogActions>
                                <Button onClick={handleCloseSwapDayModal}>
                                    إلغاء
                                </Button>
                                <Button
                                    type="submit"
                    ...
                    {selectedPerson.weekDays &&
                    selectedPerson.weekDays.length > 0 ? (
                        <TwoColumnDaysUI weekDays={selectedPerson.weekDays} />
                    ) : (
                        <Typography>
                        ...
                        >
                            <Typography
                                ...
                                sx={{
                                    borderBottom: 1,
                                    borderColor:
                                        theme.palette.dividerColor.main,
                                    mb: 1,
                                }}
                            >
                                قائمة الغياب
                                        ...
                                        (attendance, index) => {
                                            ...
                                            return (
                                                <React.Fragment key={index}>
                                                    ...
                                                    {index <
                                                        selectedPersonAttendance.length -
                                                            1 && (
                                                        <Divider
                                                            sx={{
                                                                mr: 6,
